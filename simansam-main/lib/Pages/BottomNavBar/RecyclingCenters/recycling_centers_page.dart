...
class RecyclingCenters extends ConsumerStatefulWidget {
  const RecyclingCenters({Key? key}) : super(key: key);

  @override
  _RecyclingCentersState createState() => _RecyclingCentersState();
}

class _RecyclingCentersState extends ConsumerState<RecyclingCenters> {
